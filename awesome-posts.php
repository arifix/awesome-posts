...
define('ARIFIX_AP_AP_PATH', trailingslashit(plugin_dir_path(__FILE__)));
define('ARIFIX_AP_AP_TABLE_NAME', 'arifix_ap_data');

require_once ARIFIX_AP_AP_PATH . 'includes/class-rest-routes.php';
require_once ARIFIX_AP_AP_PATH . 'includes/class-admin-menu.php';
require_once ARIFIX_AP_AP_PATH . 'includes/class-enqueues.php';
require_once ARIFIX_AP_AP_PATH . 'includes/class-shortcodes.php';
require_once ARIFIX_AP_AP_PATH . 'includes/class-helper.php';
